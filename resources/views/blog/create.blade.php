...
<div class=" container m-auto text-center pt-15 pd-5 ">
    <h1 class=" text-6xl font-bold ">Create Your Post</h1>
</div>
<div class=" container m-auto  pt-15 pd-5 ">
    <form  action="{{ route('blog.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <input class=" w-full h-20 text-6xl rounded-lg shadow-lg border-b p-15 mb-5" type="text" name="title" placeholder="TITLE">
        <textarea class=" w-full h-60 text-l rounded-lg shadow-lg border-b p-15 mb-5" name="description" placeholder="DESCRIPTION" ></textarea>
        <div class=" py-15">
            <label class="
